<div class="Left">
    <a href="/admin/?tpl=simple" class="s1"><i></i>首页</a>
    <a href="?action=inquiry&tpl=simple" class="s2"><i></i>询盘中心</a>
    <a href="javascript:void(0)" class="s3"><i></i>产品管理<i class="more"></i></a>
    <ul>
        <li><a href="?action=group&tpl=simple">产品分组管理</a></li>
        <li><a href="?action=product&tpl=simple">发布新产品</a></li>
        <li><a href="#">图片管理</a></li>
    </ul>
    <a href="?action=info&tpl=simple" class="s4"><i></i>公司管理</a>
    <a href="" class="s5"><i></i>新闻中心</a>
    <a href="" class="s6"><i></i>图片中心</a>
    <a href="" class="s7"><i></i>Banner管理</a>
    <a href="javascript:void(0)" class="s11"><i></i>首页管理<i class="more"></i></a>
    <ul>
    ...
    <div class="qrcode tc">
      <p>创业不易·我要打赏</p>
      <img src="simple/images/qrcode.png">
    </div>
  </div>
