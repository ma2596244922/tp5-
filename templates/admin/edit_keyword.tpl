{assign var=page_title value="修改关键词"}<!DOCTYPE html>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <h3 class="page-title">
                            ...
                            {$page_title} <small>修改关键词页面信息</small>
...
{include file="admin/common/op_alerts.tpl"}
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="?action=edit_keyword&keyword_id={$smarty.get.keyword_id}" method="POST" enctype="multipart/form-data" class="form-horizontal" id="form-edit-keyword">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <span class="help-inline">{$keyword.keyword}</span>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <textarea class="span12 m-wrap" id="textarea-desc-template" name="desc" rows="6">{$keyword.desc}</textarea>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <input type="hidden" name="submit" value="edit_keyword">
