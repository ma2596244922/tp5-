{assign var=page_title value="修改产品URL"}<!DOCTYPE html>
...
{include file="admin/common/op_alerts.tpl"}
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="?action=edit_product_url&product_id={$product_id}" method="POST" class="form-horizontal" id="form-edit-product">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" class="span6 m-wrap" name="path" value="{$product.path|default:{$product|url:'enterprise_url_product':1:true}}" placeholder="/high-speed-doritos-corn-chips-cutting" />
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <input type="hidden" name="submit" value="edit_product_url">
