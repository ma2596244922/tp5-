        ...
        <div class="page-sidebar nav-collapse collapse">
            ...
            <ul class="page-sidebar-menu">
                ...
                <li class="start{if $page_name=='inquiry'} active{/if}">
                    ...
                    <span class="title">询盘中心</span>

                    </a>

                </li>

                <li{if $page_name=='group' || $page_name=='edit_product' || $page_name=='product'} class="active"{/if}>
                        ...
                        <li{if $page_name=='group'} class="active"{/if}>
                            ...
                            <a href="?action=group">
                                ...
                                <i class="icon-briefcase"></i>
                                 ...
                                 <span class="title">产品分组管理</span>

                            </a>

                        </li>

                        <li{if $page_name=='edit_product'} class="active"{/if}>

                            <a href="?action=edit_product">

                                <i class="icon-reorder"></i>

                                 <span class="title">发布新产品</span>
                ...
                <li{if $page_name=='index_products' || $page_name=='user_voice' || $page_name=='index_keyword'} class="active"{/if}>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li{if $page_name=='???'} class="active"{/if}>

                            <a href="">

                                <i class="icon-file"></i>

                                 <span class="title">首页Banner</span>
