{assign var=page_title value="修改分组说明"}<!DOCTYPE html>
...
{include file="admin/common/op_alerts.tpl"}
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="?action=edit_group_desc&group_id={$group_id}" method="POST" class="form-horizontal" id="form-edit-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <textarea class="span12 m-wrap" id="textarea-desc" name="desc" rows="6">{$group.desc}</textarea>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <input type="hidden" name="submit" value="edit_group_desc">
