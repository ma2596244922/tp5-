                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-money"></i>编辑横幅</div>
                                ...
                                <form action="?action=edit_banner&banner_id={$banner_id}" method="POST" enctype="multipart/form-data" class="form-horizontal" id="form-edit-banner">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="fileupload fileupload-{if $banner.uri|default:''}exists{else}new{/if} span2" data-provides="fileupload">
