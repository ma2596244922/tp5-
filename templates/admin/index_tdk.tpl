...
{include file="admin/common/sidebar.tpl" page_name="index_tdk"}
...
{include file="admin/common/profile_l2menu.tpl" profile_page_name="index_tdk"}
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tab_1-1" class="tab-pane active">
                                                        ...
                                                        <div style="height: auto;" id="accordion1-1" class="accordion collapse">
                                                            ...
                                                            <form action="?action=index_tdk" method="POST">

                                                                <label class="control-label">HTML Title</label>

                                                                <input type="text" name="html_title" class="m-wrap span8" value="{$title|default:''}" />

                                                                <label class="control-label">Meta Keywords</label>

                                                                <textarea class="span8 m-wrap" name="meta_keywords" rows="6">{$keywords|default:''}</textarea>

                                                                <label class="control-label">Meta Description</label>

                                                                <textarea class="span8 m-wrap" name="meta_description" rows="6">{$description|default:''}</textarea>
