{assign var=page_title value="清理内容"}<!DOCTYPE html>
...
{include file="admin/common/op_alerts.tpl"}
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="?action=cleanup_content" method="POST" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class="checkbox">
                                                <input type="checkbox" name="cleanup_type[]" value="1" />
                                                清理链接
                                            </label>

                                            <label class="checkbox">
                                                <input type="checkbox" name="cleanup_type[]" value="2" />
                                                清理图片
                                            </label>
