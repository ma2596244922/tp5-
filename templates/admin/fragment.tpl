...
{include file="admin/common/sidebar.tpl" page_name="fragment"}
...
{include file="admin/common/profile_l2menu.tpl" profile_page_name="fragment"}
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tab_1-1" class="tab-pane active">
                                                        ...
                                                        <div style="height: auto;" id="accordion1-1" class="accordion collapse">
                                                            ...
                                                            <form action="?action=fragment" method="POST">

                                                                <label class="control-label">全站通用</label>

                                                                <textarea class="span8 m-wrap" name="common_fragment" rows="6">{$site.common_fragment|default:''}</textarea>

                                                                <label class="control-label">询盘页</label>

                                                                <textarea class="span8 m-wrap" name="contactnow_fragment" rows="6">{$site.contactnow_fragment|default:''}</textarea>

                                                                <label class="control-label">询盘成功页</label>
