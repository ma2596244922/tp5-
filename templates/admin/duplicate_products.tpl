{assign var=page_title value="批量复制产品"}<!DOCTYPE html>
...
{include file="admin/common/op_alerts.tpl"}
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="?action=duplicate_products&product_id={$smarty.get.product_id}" method="POST" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" class="span1 m-wrap" name="cnt" value="5" />
...
{/section}
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <input type="hidden" name="submit" value="duplicate_products">

                                        <button type="submit" class="btn blue">开始复制</button>
