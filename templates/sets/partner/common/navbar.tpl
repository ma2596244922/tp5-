    ...
    <div class="nav-inner">
        ...
        <div class="select-flag current" data-role="selectParent">
            <div class="select-box fl-clr" data-role="ShowParent">
                <span class="selectTxt" data-role="SearchShow"><img src="/media/sets/partner/images/langflags/{$lang_code}.png" width="16" height="11">{$supported_lang_codes[$lang_code].locale_label|default:'English'}</span>
                <i></i>
            </div>
