...
<head>
    ...
    <link href="/media/sets/june-sky/css/cmopany_detail.css" rel="stylesheet" type="text/css" />
</head>
<body>
{include file="sets/june-sky/common/header.tpl" cur="quality"}
<!-- header -->
...
<div class="main_wrap">
    ...
    <div class="sider_wrap fl">
        {include file="sets/june-sky/common/left.tpl"}
        <div class="cb_10"></div>
    </div>
