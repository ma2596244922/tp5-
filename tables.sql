...
CREATE TABLE `enterprise_inquiries` (
  ...
  `price_n_terms` tinyint(3) unsigned NOT NULL COMMENT 'Price & Terms',
  `payment` tinyint(3) unsigned NOT NULL COMMENT 'Payment',
  `initial_order` varchar(45) NOT NULL COMMENT 'Initial Order',
  `sample_terms` tinyint(3) unsigned NOT NULL COMMENT 'Sample Terms',
