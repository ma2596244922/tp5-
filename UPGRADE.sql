...
ALTER TABLE `enterprise_groups`
  ...
  ALTER COLUMN `cnt` SET DEFAULT '0',
  ALTER COLUMN `deleted` SET DEFAULT '0',
  CHANGE COLUMN `path` `path` text COMMENT '自定义路径',
  CHANGE COLUMN `path_sum` `path_sum` binary(16) COMMENT '自定义路径的摘要',
  ALTER COLUMN `purl_prefix` SET DEFAULT '',
  CHANGE COLUMN `product_html_title` `product_html_title` text COMMENT '产品页T',
  CHANGE COLUMN `product_meta_keywords` `product_meta_keywords` text COMMENT '产品页K',
  CHANGE COLUMN `product_meta_description` `product_meta_description` text COMMENT '产品页D',
  CHANGE COLUMN `html_title` `html_title` text COMMENT 'T',
  CHANGE COLUMN `meta_keywords` `meta_keywords` text COMMENT 'K',
  CHANGE COLUMN `meta_description` `meta_description` text COMMENT 'D',
  CHANGE COLUMN `desc` `desc` text COMMENT '说明文本',
  ALTER COLUMN `product_give_h1_to` SET DEFAULT '0',
  ALTER COLUMN `product_video_uri` SET DEFAULT '',
  ALTER COLUMN `product_video_cover_uri` SET DEFAULT '',
  ALTER COLUMN `product_video_duration` SET DEFAULT '',
  ALTER COLUMN `ranking` SET DEFAULT '0';
ALTER TABLE `enterprise_products`
  CHANGE COLUMN `description` `description` text COMMENT '产品描述',
  ...
  ALTER COLUMN `brand_name` SET DEFAULT '',
  ALTER COLUMN `model_number` SET DEFAULT '',
  ALTER COLUMN `certification` SET DEFAULT '',
  ALTER COLUMN `place_of_origin` SET DEFAULT '',
  ALTER COLUMN `min_order_quantity` SET DEFAULT '',
  ALTER COLUMN `price` SET DEFAULT '',
  ALTER COLUMN `payment_terms` SET DEFAULT '',
  ALTER COLUMN `supply_ability` SET DEFAULT '',
  ALTER COLUMN `delivery_time` SET DEFAULT '',
  ALTER COLUMN `packaging_details` SET DEFAULT '',
  CHANGE COLUMN `specifications` `specifications` text COMMENT '产品属性（JSON）',
  ALTER COLUMN `head_image_id` SET DEFAULT '0',
  CHANGE COLUMN `images` `images` text COMMENT '产品图片（JSON）',
  ...
  CHANGE COLUMN `path` `path` text COMMENT '自定义路径',
  CHANGE COLUMN `path_sum` `path_sum` binary(16) COMMENT '自定义路径的摘要',
  CHANGE COLUMN `embedded_video` `embedded_video` text COMMENT '嵌入视频代码';
-- 2018-7-28
ALTER TABLE `oms_sites`
  ALTER COLUMN `desc` SET DEFAULT '',
  ALTER COLUMN `qq` SET DEFAULT '',
  ALTER COLUMN `wechat` SET DEFAULT '',
  ALTER COLUMN `name` SET DEFAULT '',
  ALTER COLUMN `tel` SET DEFAULT '',
  ALTER COLUMN `sex` SET DEFAULT '0',
  CHANGE COLUMN `csr` `csr` text COMMENT 'CSR',
  CHANGE COLUMN `KEY` `key` text COMMENT 'Key',
  ALTER COLUMN `vps_id` SET DEFAULT '0',
  ALTER COLUMN `industry_id` SET DEFAULT '0',
  ALTER COLUMN `type` SET DEFAULT '0',
  CHANGE COLUMN `created` `created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  CHANGE COLUMN `updated` `updated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最近修改时间',
  ALTER COLUMN `crawled` SET DEFAULT '0',
  ALTER COLUMN `enable_translator` SET DEFAULT '0';
ALTER TABLE `enterprise_sites`
  CHANGE COLUMN `updated` `updated` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最近修改时间',
  ALTER COLUMN `start_year`  SET DEFAULT '0',
  CHANGE COLUMN `common_fragment` `common_fragment` text COMMENT '通用HTML代码片段',
  CHANGE COLUMN `contactnow_fragment` `contactnow_fragment` text COMMENT '询盘页HTML代码片段',
  CHANGE COLUMN `contactsave_fragment` `contactsave_fragment` text COMMENT '询盘成功页HTML代码片段',
  ALTER COLUMN `product_cnt`  SET DEFAULT '0',
  CHANGE COLUMN `index_products` `index_products` text COMMENT '首页推荐产品ID清单（JSON）',
  CHANGE COLUMN `user_voices` `user_voices` text COMMENT '首页用户赠言（JSON）',
  CHANGE COLUMN `index_html_title` `index_html_title` text COMMENT '首页T',
  CHANGE COLUMN `index_meta_keywords` `index_meta_keywords` text COMMENT '首页K',
  CHANGE COLUMN `index_meta_description` `index_meta_description` text COMMENT '首页D',
  CHANGE COLUMN `desc_4_inquiry_sender` `desc_4_inquiry_sender` text COMMENT '信息说明',
  ALTER COLUMN `product_tdk_scope` SET DEFAULT '0',
  CHANGE COLUMN `product_html_title` `product_html_title` text COMMENT '产品页T',
  CHANGE COLUMN `product_meta_keywords` `product_meta_keywords` text COMMENT '产品页K',
  CHANGE COLUMN `product_meta_description` `product_meta_description` text COMMENT '产品页D',
  CHANGE COLUMN `contact_content` `contact_content` text COMMENT '联系页替代正文',
  CHANGE COLUMN `common_head_fragment` `common_head_fragment` text COMMENT '通用HTML head代码片段',
  ALTER COLUMN `product_default_image`  SET DEFAULT '0',
  ALTER COLUMN `common_bg_image`  SET DEFAULT '0',
  ALTER COLUMN `enable_mobile_sites` SET DEFAULT '0',
  ALTER COLUMN `enable_https` SET DEFAULT '0',
  ALTER COLUMN `offline` SET DEFAULT '0',
  ALTER COLUMN `purl_prefix` SET DEFAULT '',
  ALTER COLUMN `gurl_prefix` SET DEFAULT '',
  CHANGE COLUMN `favicon` `favicon` mediumblob COMMENT '收藏夹小图标数据',
  CHANGE COLUMN `lang_codes` `lang_codes` text COMMENT '语种清单（JSON）',
...
ALTER TABLE `enterprise_corporations`
  ...
  ALTER COLUMN `factory_address` SET DEFAULT '',
  ALTER COLUMN `worktime` SET DEFAULT '',
  ALTER COLUMN `tel_wt` SET DEFAULT '',
  ALTER COLUMN `tel_nwt` SET DEFAULT '',
  ALTER COLUMN `fax` SET DEFAULT '',
  ALTER COLUMN `skype` SET DEFAULT '',
  ALTER COLUMN `email` SET DEFAULT '',
  ALTER COLUMN `yahoo` SET DEFAULT '',
  ALTER COLUMN `logo` SET DEFAULT '0',
  ALTER COLUMN `business_type` SET DEFAULT '',
  ALTER COLUMN `main_market` SET DEFAULT '',
  ALTER COLUMN `brands` SET DEFAULT '',
  ALTER COLUMN `no_of_employees` SET DEFAULT '',
  ALTER COLUMN `annual_sales` SET DEFAULT '',
  ALTER COLUMN `year_established` SET DEFAULT '',
  ALTER COLUMN `export_p_c` SET DEFAULT '',
  CHANGE COLUMN `introduction` `introduction` text COMMENT 'Introduction',
  CHANGE COLUMN `history` `history` text COMMENT 'History',
  CHANGE COLUMN `service` `service` text COMMENT 'Service',
  CHANGE COLUMN `our_team` `our_team` text COMMENT 'Our Team',
  CHANGE COLUMN `qc_profile` `qc_profile` text COMMENT 'QC Profile',
...
ALTER TABLE `enterprise_groups`
  ...
  ADD COLUMN `product_video_duration` varchar(10) NOT NULL COMMENT '产品页视频时长';
